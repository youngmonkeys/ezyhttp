...
public final class PropertyNames {
	...
	public static final String RESOURCE_DOWNLOAD_THREAD_POOL_SIZE = "resources.download.thread_pool_size";
	...
	public static final String RESOURCE_UPLOAD_THREAD_POOL_SIZE = "resources.upload.thread_pool_size";
