...
public final class ResourceResolvers {
    ...
    createDownloadManager(EzyPropertyFetcher propertyFetcher) {
        ...
        int threadPoolSize = propertyFetcher
            .getProperty(RESOURCE_DOWNLOAD_THREAD_POOL_SIZE, int.class,
                ResourceDownloadManager.DEFAULT_THREAD_POOL_SIZE);
        int bufferSize = propertyFetcher
            .getProperty(RESOURCE_DOWNLOAD_BUFFER_SIZE, int.class,
                ResourceDownloadManager.DEFAULT_BUFFER_SIZE);
    ...
    public static ResourceUploadManager createUploadManager(EzyPropertyFetcher propertyFetcher) {
        ...
        int threadPoolSize = propertyFetcher
            .getProperty(RESOURCE_UPLOAD_THREAD_POOL_SIZE, int.class,
                ResourceUploadManager.DEFAULT_THREAD_POOL_SIZE);
        int bufferSize = propertyFetcher
            .getProperty(RESOURCE_UPLOAD_BUFFER_SIZE, int.class,
                ResourceUploadManager.DEFAULT_BUFFER_SIZE);
